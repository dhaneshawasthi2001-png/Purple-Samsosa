...
export default function Footer() {
  ...
  return (
    <footer className="bg-purple-deep text-cream-base pt-28 pb-16 border-t border-purple-soft/20 relative overflow-hidden">
      {/* Noise filter */}
      <div className="grain-overlay" />

      <div className="max-w-[1280px] mx-auto px-6 md:px-8 relative z-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 pb-16 border-b border-purple-soft/10">
        
        {/* Left Area: Logo & Tagline */}
        <div className="lg:col-span-5 space-y-6">
          <Link href="#home" className="flex items-center w-fit bg-cream-base px-5 py-2.5 rounded-2xl shadow-md">
            <Image
              src="/logo.png"
      ...
      {/* Bottom Panel */}
      <div className="max-w-[1280px] mx-auto px-6 md:px-8 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 font-body text-xs text-purple-faint">
